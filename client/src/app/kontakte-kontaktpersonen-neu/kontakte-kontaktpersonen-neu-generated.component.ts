/*
  ...
  Modify kontakte-kontaktpersonen-neu.component.ts instead.
*/
...
export class KontakteKontaktpersonenNeuGenerated implements AfterViewInit, OnInit, OnDestroy {
  // Components
  @ViewChild('content1') content1: ContentComponent;
  @ViewChild('templateFormKontaktpersonen') templateFormKontaktpersonen: TemplateFormComponent;
  ...
  templateFormKontaktpersonenSubmit(event: any) {
    this.dbOptimo.createBaseKontakte(null, Object.assign(event, { BaseID: this.parameters.BaseID }))
    .subscribe((result: any) => {
      this.notificationService.notify({ severity: "success", summary: ``, detail: `Kontaktperson erstellt` });

      this.dialogRef.close(event);
    }, (result: any) => {
      this.notificationService.notify({ severity: "error", summary: ``, detail: `Kontaktperson konnte nicht erstellt werden!` });
    });
  }
