/*
  ...
  Modify handbuch.component.ts instead.
*/
...
export class HandbuchGenerated implements AfterViewInit, OnInit, OnDestroy {
  // Components
  ...
  load() {
    this.dbOptimo.getInfotexteHtmls(`Code eq 'Benutzerhandbuch'`, null, null, null, null, null, null, null)
    .subscribe((result: any) => {
      this.handbuchHtml = result.value[0].Inhalt;
    }, (result: any) => {
