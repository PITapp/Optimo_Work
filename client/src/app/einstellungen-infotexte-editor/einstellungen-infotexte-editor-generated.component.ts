/*
  ...
  Modify einstellungen-infotexte-editor.component.ts instead.
*/
...
export class EinstellungenInfotexteEditorGenerated implements AfterViewInit, OnInit, OnDestroy {
  // Components
  ...
  load() {
    ...
    .subscribe((result: any) => {
      this.dsoInfotexteHTML = result;

      this.strInfotextHTML = result.Inhalt;
  ...
  button0Click(event: any) {
    this.dsoInfotexteHTML.Inhalt = this.strInfotextHTML;

    this.dbOptimo.updateInfotexteHtml(null, this.parameters.InfotextID, this.dsoInfotexteHTML)
    .subscribe((result: any) => {
