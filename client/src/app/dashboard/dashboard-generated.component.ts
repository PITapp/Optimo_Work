...
export class DashboardGenerated implements AfterViewInit, OnInit, OnDestroy {
  ...
  grid0Add(event: any) {
    ...
    this.router.navigate(['add-test-base']);
  }

  grid0Delete(event: any) {
    this.dbOptimo.deleteBase(event.BaseID)
  ...
  grid0LoadData(event: any) {
    this.dbOptimo.getBases(`${event.filter}`, event.top, event.skip, `${event.orderby}`, event.top != null && event.skip != null, null, null, null)
    .subscribe((result: any) => {
  ...
  grid0RowSelect(event: any) {
    ...
    this.router.navigate(['edit-test-base', event.BaseID]);
  }
