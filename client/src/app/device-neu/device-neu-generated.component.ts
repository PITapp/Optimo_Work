/*
  ...
  Modify device-neu.component.ts instead.
*/
...
export class DeviceNeuGenerated implements AfterViewInit, OnInit, OnDestroy {
  // Components
  ...
  form0Submit(event: any) {
    this.dbOptimo.createInventurDevice(null, event)
    .subscribe((result: any) => {
      this.notificationService.notify({ severity: "success", summary: ``, detail: `Gerät erstellt` });

      this.dialogRef.close(result);
    }, (result: any) => {
      this.notificationService.notify({ severity: "error", summary: `Error`, detail: `Gerät konnte nicht erstellt werden!` });
    });
  }
