/*
  ...
  Modify versionen.component.ts instead.
*/
...
export class VersionenGenerated implements AfterViewInit, OnInit, OnDestroy {
  ...
  load() {
    this.dbOptimo.getInfotexteHtmls(`Code eq 'VersionenWeb'`, null, null, null, null, null, null, null)
    .subscribe((result: any) => {
      this.versionenHtml = result.value[0].Inhalt;
    }, (result: any) => {
